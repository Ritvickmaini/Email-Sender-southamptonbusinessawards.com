            ...
            <tr>
              <td style="padding:30px">
                ...
                <p style="margin-top:25px;font-weight:bold">
                  ...
                  29th Jan 2026 | Southampton Business Expo<br/>
                  <br/>
                  On Behalf of<br/>
                  Roger<br/>
                  Show Director<br/>
                  <a href="mailto:roger@southamptonbusinessawards.com"
                     style="color:#D7262F">roger@southamptonbusinessawards.com</a><br/>
                </p>
...
def send_email(sender_email, sender_password, row, subject, custom_html, cta_text, cta_url):
    try:
        server = smtplib.SMTP("mail.southamptonbusinessawards.com", 587)
        server.starttls()
...
sender_email = st.text_input("Sender Email", value="roger@southamptonbusinessawards.com")
